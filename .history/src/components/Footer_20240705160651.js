            ...
            <div className="container text-white">
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <h5>Follow Us</h5>
                        <p>
                            <a href="https://www.youtube.com/channel/UCGMA_ZJ0uvBKVe8IG7uaSSA" className="me-2 nav-link" target="_blank" rel="noreferrer">YouTube</a> |
                            <a href="https://www.tiktok.com/@etherialphoenix" className="mx-2 nav-link" target='_blank' rel='noreferrer'>TikTok</a>
