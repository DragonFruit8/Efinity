                ...
                <div className="container">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <p>Develop and launch the first program initiative focused on clean air and community gardening, incorporating home greenhouses and like-kind exchanges.</p>
                        </li>
                        <li>
                            <h2>Establish Partnership Program</h2>
                            <p>Develop a balanced business program with existing partners to ensure mutual benefits, sustainability, and community impact.</p>
                        </li>
                    </ul>
                </div>
            </section>
