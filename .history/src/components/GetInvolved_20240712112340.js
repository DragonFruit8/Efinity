...
import VoPic from '../../src/Image/gabriel-barletta-OuLVg5ZKphI-unsplash.jpg';
...
const GetInvolved = () => {
    ...
    function Vo() {
        return <img id='img' src={VoPic} className="card-img-top" alt="Custom Floral Arrangements" />;
    }
