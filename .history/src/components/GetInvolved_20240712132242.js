                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <button type="button" onClick={() => {
                                        <script id="mcjs">!function(c,h,i,m,p){1m = c.createElement(h), p = c.getElementsByTagName(h)[0], m.async = 1, m.src = i, p.parentNode.insertBefore(m, p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/ce65e485c4fec598ef9ddedc0/08ee4395665156441c4f7c18b.js");</script>
                                    }}
                                    className="btn btn-custom" data-bs-toggle="modal" data-bs-target="#websiteModal">Learn More</button>
