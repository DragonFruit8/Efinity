                        ...
                        <div className="card mb-4">
                            ...
                            <div className="card-body">
                                ...
                                <button className="btn btn-custom mb-2" onClick={() => {
                                    window.open("https://form.jotform.com/241865571581161", "_blank");
                                }}>
                                    REQUEST QUOTE
                                </button>
                            </div>
                        ...
                        <div className="card mb-4">
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Website Development</h5>
                                    ...
                                    {/* Modal button */}
                                    <button className="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#ClientForm">
                                        GET QUOTE
                                    </button>
                            </div>
                        </div>
                        ...
                        <div className="card mb-4">
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    Start your dance journey here and be welcomed with a "First Dance"
                                </p>
                                <button className="btn btn-custom mb-2" onClick={() => {
                                    window.open("https://www.jotform.com/build/233075606770154", "_blank");
                                }}>
                                    GET FIRST DANCE
                                </button>
                            </div>
