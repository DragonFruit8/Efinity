                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <p className="nav-items">
                            <a to="/" className="d-block nav-link">Home</a>
                            <a to="/about" className="d-block nav-link">About</a>
                            <a to="/services" className="d-block nav-link">Services</a>
                            {/* <Link to="/shop" className="d-block nav-link">Shop</Link> */}
                            <a to="/contact" className="d-block nav-link">Contact</a>
                        </p>
                    </div>
                </div>
