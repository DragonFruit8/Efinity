                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                {dance()}
                                <div className="card-body">
                                    <h5 className="card-title">Dance Classes</h5>
                                    <p className="card-text">Join our dance classes to learn new moves and meet new friends. All skill levels are welcome.</p>
                                    <button type="button" className="btn btn-custom" data-bs-toggle="modal" data-bs-target="#websiteModal">Learn More</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Get a custom website for your business or organization. Our team of developers will bring your vision to life.</p>
                                    <button type="button" className="btn btn-custom" data-bs-toggle="modal" data-bs-target="#websiteModal">Learn More</button>
                                </div>
                            </div>
                        </div>
