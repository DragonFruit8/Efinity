                    ...
                    <div className="col-md-4 text-center">
                        <div className="card mb-4">
                            ...
                            <div className="card-body">
                                ...
                                <a type="button" className="btn btn-primary" href="javascript:void(window.open('https://form.jotform.com/233604899004156','blank','scrollbars=yes,toolbar=no,width=700,height=500'))" ref>
