                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="card">
                                <img id='img' src={Volunteer} className="card-img-top" alt="Custom Floral Arrangements" />
                                <div className="card-body">
                                    ...
                                    <button type="button" className="btn btn-custom" href='https://chimpstatic.com/mcjs-connected/js/users/ce65e485c4fec598ef9ddedc0/08ee4395665156441c4f7c18b.js'>Learn More</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="card">
                                <img id='img' src={Advocate} className="card-img-top" alt="Dance Classes" />
                                <div className="card-body">
                                    ...
                                    <button type="button" className="btn btn-custom" data-bs-toggle="modal" href='https://chimpstatic.com/mcjs-connected/js/users/ce65e485c4fec598ef9ddedc0/08ee4395665156441c4f7c18b.js'>Learn More</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="card">
                                    <img id='img' src={Educate} className="card-img-top" alt="Web Development" />
                                <div className="card-body">
                                    ...
                                    {/* OnClick button script popup */}
                                    <button type="button" className="btn btn-custom" href='https://chimpstatic.com/mcjs-connected/js/users/ce65e485c4fec598ef9ddedc0/08ee4395665156441c4f7c18b.js'>
                                        Learn More
