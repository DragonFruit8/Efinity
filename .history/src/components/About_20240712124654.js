...
import communityPic from '../../src/Image/Community.webp';
import Roadmap from './RoadMap';

function community() {
    return <img id='aboutImg' src={communityPic} className="img-fluid" alt="About Us" />;
}
...
const About = () => {
    ...
    const values = [
        { title: 'Community', description: 'Unity and Collaboration' },
        { title: 'Sustainability', description: 'Environmental Stewardship' },
        { title: 'Innovation', description: 'Technological Advancements' },
        { title: 'Interconnectedness', description: 'Cosmic Harmony' }
    ];
...
Learn about our efforts to achieve 501(c)(3) status, support initial startup costs, and provide a basic monthly income allowance to ensure a minimal standard of living. */}
            ...
            <section id="values" className="py-5 bg-dark text-light">
                <div className="container">
                    <div className="values-list">
                        <h2>Our Values</h2>
                        <ul className="list-unstyled values">
