...
import djPic from '../../public/gabriel-barletta-OuLVg5ZKphI-unsplash.jpg';
const Services = () => {

    function dj() {
        return <img src={djPic} className="card-img-top" alt="Custom Floral Arrangements" />;
    }
                ...
                <div className="row">
                    <div className="col-md-4 text-center">
                        <div className="card mb-4">
                            <img src={dj} className="card-img-top" alt="Custom Floral Arrangements" />
                    ...
                    <div className="col-md-4 text-center">
                        <div className="card mb-4">
                            <img src="../../public/javier-allegue-barros-55bVEzGVnzY-unsplash.jpg" className="card-img-top" alt="Same-Day Delivery" />
                            <div className="card-body">
