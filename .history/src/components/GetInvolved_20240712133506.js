                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <button type="button" className="btn btn-custom" onClick="https://www.signupanywhere.com/signup/nsvi74pr" target="_blank">Learn More</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <button type="button" className='btn btn-custom' href='https://www.signupanywhere.com/signup/nsvi74pr' target="_blank">
                                        Learn More
